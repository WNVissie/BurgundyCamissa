...
@roster_bp.route('/<int:roster_id>', methods=['PUT'])
@jwt_required()
...
@roster_bp.route('/<int:roster_id>', methods=['DELETE'])
@jwt_required()
...
@roster_bp.route('/<int:roster_id>/approve', methods=['POST'])
@jwt_required()
...
@roster_bp.route('/bulk', methods=['POST'])
@jwt_required()
